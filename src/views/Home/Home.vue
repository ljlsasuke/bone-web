        ...
        <el-drawer v-model="isDrawerShow" size="50%" style="border-radius: 6px 0 0 6px;"
            ...
            <template #default>
                <div class="form-card">
                    ...
                    <el-form label-position="left" label-width="80" ref="formRefP" class="form">
                        <el-form-item label="病人姓名" prop="oldPwd">
                            <el-input placeholder="请输入病人姓名"></el-input>
                        </el-form-item>
                        <el-form-item label="患者ID" prop="newPwd">
                            <el-input placeholder="请输入患者ID"></el-input>
                        </el-form-item>
                        <el-form-item label="年龄" prop="confirmPwd">
                            <el-input placeholder="请输入患者年龄"></el-input>
                        </el-form-item>
                        <el-form-item label="身高(cm)" prop="confirmPwd">
                            <el-input placeholder="请输入患者身高"></el-input>
                        </el-form-item>
                        <el-form-item label="既往病史" prop="confirmPwd">
                            <el-input placeholder="请输入患者既往病史"></el-input>
                        </el-form-item>
                    </el-form>
                </div>
                <div class="form-card">
                    <h1 class="form-card-title">医生基本信息</h1>
                    <el-form label-position="left" label-width="80" ref="formRefD" class="form">
                        <el-form-item label="医生姓名" prop="oldPwd">
                            <el-input placeholder="请输入医生姓名"></el-input>
                        </el-form-item>
                        <el-form-item label="医生ID" prop="newPwd">
                            <el-input placeholder="请输入医生ID"></el-input>
                        </el-form-item>
                    </el-form>
                </div>
                <div class="form-card">
